                ...
                if (list != null) {
                    ...
                    if (leftNeighbor != null && rightNeighbor != null && straightNeighbor != null) {
                        ...
                        if (rightNeighbor != null) {
                            ...
                            neighbors.add(p1);
                            // neighborGraph.put(entry.getKey(), neighbors);
                            // System.out.println(((ExtendedRectangle) entry.getKey()).getId() + " " + ((ExtendedRectangle) rightNeighbor).getId() + " " + ((ExtendedRectangle) rightNeighbor).getId());
                            // System.out.println("");
                        }
                        ...
                        if (leftNeighbor != null || rightNeighbor != null || straightNeighbor != null) {
                            if (neighborGraph.get(entry.getKey()) != null) {
                                //System.out.println("AA " + ((ExtendedRectangle)entry.getKey()).getId());
                                neighborGraph.get(entry.getKey()).removeAll(neighborGraph.get(entry.getKey()));
                                // System.out.println("DSA " + neighborGraph.get(entry.getKey()));
                                neighborGraph.replace(entry.getKey(), neighbors);
                            } else {
                                System.out.println("BB " + ((ExtendedRectangle) entry.getKey()).getId());
                                neighborGraph.put(entry.getKey(), neighbors);
                            }
                ...
                for (Pair<ExtendedShape, String> pair : list) {
                    if (pair.getKey() == entry.getKey()) {
                        ...
                        if (searchDirection.equals(directionToHallway)) {
                            if (searchDirection.equals("Down") || searchDirection.equals("Up")) {
                                if (Math.abs(entry.getKey().getStartPoint().getX() - sh.getStartPoint().getX()) < minDistance) {
                                    currentShape = entry.getKey();
                                    minDistance = Math.abs(entry.getKey().getStartPoint().getX() - sh.getStartPoint().getX());
                                }
                            } else {
                                if (Math.abs(entry.getKey().getStartPoint().getY() - sh.getStartPoint().getY()) < minDistance) {
                                    currentShape = entry.getKey();
                                    minDistance = Math.abs(entry.getKey().getStartPoint().getY() - sh.getStartPoint().getY());
                                }
                            }
                        }
                        // System.out.println(((ExtendedRectangle)entry.getKey()).getId() + " " + relationToHallway);
