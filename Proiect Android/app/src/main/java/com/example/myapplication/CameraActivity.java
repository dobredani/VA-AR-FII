...
public class CameraActivity extends AppCompatActivity {
    ...
    public String seVaAfisa = "Scanati primul cod";
    public static String culoareText = "black";
    public static String culoareBackground = "white";


    public void updateCameraOverlay(String text, String colorText, String colorBackground){
        seVaAfisa = text;
        culoareText = colorText;
        culoareBackground = colorBackground;
    }
    ...
    protected void onResume() {
        ...
        if (!isCameraInitialized) {
            ...
            t = addTextViewOverlay(R.id.text_view_id);
            ...
            displayController.addOverlay(t, culoareText, culoareBackground, seVaAfisa, 90, 135);
