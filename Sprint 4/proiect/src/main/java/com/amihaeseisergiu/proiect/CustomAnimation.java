...
public class CustomAnimation {
    ...
    public static void animateInFromRightWithBounce(Scene scene, Node slide)
    {
        slide.translateXProperty().set(scene.getWidth());
    ...
    public static void animateOutToLeftAndRemove(Scene scene, Node slide, List<Node> removeFrom)
    {
        Timeline moveOut = new Timeline();
        KeyValue kv = new KeyValue(slide.translateXProperty(), -scene.getWidth(), Interpolator.EASE_OUT);
    ...
    public static void animateInFromLeftWithBounce(Scene scene, Node slide)
    {
        slide.translateXProperty().set(-scene.getWidth());
        Timeline moveIn = new Timeline();
        KeyValue kv = new KeyValue(slide.translateXProperty(), 0, Interpolator.EASE_IN);
    ...
    public static void animateInFromLeft(Scene scene, Node slide)
    {
        slide.translateXProperty().set(-scene.getWidth());
        Timeline moveOut = new Timeline();
    ...
    public static void animateInFromTop(Scene scene, Node slide)
    {
        slide.translateYProperty().set(-scene.getHeight());
        Timeline moveOut = new Timeline();
